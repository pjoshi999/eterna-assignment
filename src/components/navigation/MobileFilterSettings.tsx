...
export function MobileFilterSettings() {
  ...
  const protocols = [
    ...
    { id: "raydium", label: "Raydium", color: "green", icon: "ri-link" },
  ...
  return (
    <div className="w-full bg-[#101114] text-white border-t border-[#22242d] animate-in slide-in-from-top-[10px] fade-in duration-200">
      {/* Header */}
      ...
      {/* Status Tabs */}
      <div className="flex gap-4 p-4 border-b border-[#22242d]">
      ...
      <div className="p-4">
        ...
        <div className="grid grid-cols-2 gap-2">
          <button className="flex items-center gap-2 px-3 py-2 bg-[#15161a] border border-[#4ade80] rounded-full">
            ...
            <span className="text-[#4ade80] text-[12px] font-medium">SOL</span>
          </button>
          <button className="flex items-center gap-2 px-3 py-2 bg-[#15161a] border border-[#1a1b1f] rounded-full">
            ...
            <span className="text-[#3b82f6] text-[12px] font-medium">USDC</span>
          </button>
          <button className="flex items-center gap-2 px-3 py-2 bg-[#15161a] border border-[#1a1b1f] rounded-full">
            <span className="text-[#eab308] text-[12px] font-medium">1</span>
            <span className="text-[#eab308] text-[12px] font-medium">USD1</span>
          </button>
        </div>
      </div>

      {/* Footer */}
      <div className="p-4 bg-[#101114] border-t border-[#22242d] flex items-center gap-4">
